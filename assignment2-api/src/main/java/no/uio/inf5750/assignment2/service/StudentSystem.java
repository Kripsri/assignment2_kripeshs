...
public interface StudentSystem {
     ...
     * @param studentId the id of the student whose location needs to be set
     * @param latitude the latitude of the student location
     * @param longitude the longitude of the student location
     */
